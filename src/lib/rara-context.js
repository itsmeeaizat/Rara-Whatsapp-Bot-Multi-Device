...
const keys = [
  ["rara-games", (buf) => { gameThumbBuffer = buf; }],
  ["rara-rpg", (buf) => { rpgThumbBuffer = buf; }],
  ["rara-winner", (buf) => { winnerThumbBuffer = buf; }],
];
...
function createFakeQuoted(botName = "Rara-AI", verified = true) {
  return {
    key: {
      fromMe: false,
