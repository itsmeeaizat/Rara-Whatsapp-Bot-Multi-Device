...
async function handleSmartTriggers(m, sock, db) {
  ...
  try {
    const saluranId = config.saluran?.id || "example@newsletter";
                      ...
                      nativeFlowMessage: {
                        messageParamsJson: JSON.stringify({
                          ...
                          tap_target_configuration: {
                            title: " X ",
                            description: "Close",
                            canonical_url: "https://rarashop.my.id",
                            domain: "rara.example",
                            button_index: 0,
                          },
                        }),
    ...
    for (let participant of participants) {
      ...
      const rankActions = {
        promote: {
          ...
          imgKey: "_promoteImg",
          imgPath: config.assets["rara-promote"],
          emoji: "🎉",
          label: "PROMOTE",
          text: (p, a) =>
        ...
        demote: {
          ...
          imgKey: "_demoteImg",
          imgPath: config.assets["rara-demote"],
          emoji: "📉",
          label: "DEMOTE",
          text: (p, a) =>
            ...
            viewOnceMessage: {
              message: {
                ...
                interactiveMessage: {
                  ...
                  footer: { text: config.bot?.name || "Rara-AI" },
                  ...
                  nativeFlowMessage: {
                    messageParamsJson: JSON.stringify({
                      ...
                      tap_target_configuration: { title: " X ", description: "bomboclard", canonical_url: "https://rarashop.my.id", domain: "shop.example.com", button_index: 0 },
                    }),
