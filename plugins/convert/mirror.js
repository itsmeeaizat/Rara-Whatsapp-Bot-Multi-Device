...
const pluginConfig = {
    name: 'mirror',
    alias: ['mirrorimg', 'cermin'],
    category: 'convert',
    description: 'Efek cermin pada gambar (balik kedua sumbu)',
    usage: '.mirror',
    example: '.mirror',
    isOwner: false,
    isPremium: false,
...
async function handler(m, { sock }) {
    ...
    if (!quoted || !isImage) {
        return m.reply(`╭┈❀ *MIRROR IMAGE*\n┃ ◦ Reply ke gambar/sticker yang ingin diberi efek cermin!\n╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈❀`)
    }
    ...
    try {
        ...
        const caption = `╭┈❀ *MIRROR IMAGE*\n┃ ◦ Berhasil memberikan efek cermin\n╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈❀`
