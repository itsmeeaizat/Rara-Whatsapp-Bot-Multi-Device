...
const pluginConfig = {
    name: 'contrast',
    alias: ['contrastimg', 'kontras'],
    category: 'convert',
    description: 'Atur kontras gambar (-1.0 sampai 1.0)',
    usage: '.contrast <value -1 to 1>',
    example: '.contrast 0.3',
    isOwner: false,
    isPremium: false,
    isGroup: false,
    isPrivate: false,
...
async function handler(m, { sock }) {
    ...
    if (text) {
        ...
        if (isNaN(val) || val < -1 || val > 1) {
            return m.reply(`╭┈❀ *CONTRAST IMAGE*\n┃ ◦ Nilai kontras harus antara -1.0 sampai 1.0!\n┃ ◦ Contoh: .contrast 0.3\n╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈❀`)
        }
    }
    ...
    if (!quoted || !isImage) {
        return m.reply(`╭┈❀ *CONTRAST IMAGE*\n┃ ◦ Reply ke gambar/sticker yang ingin diatur kontrasnya!\n╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈❀`)
    }
    ...
    try {
        ...
        const caption = `╭┈❀ *CONTRAST IMAGE*\n┃ ◦ Berhasil mengatur kontras gambar\n┃ ◦ Nilai: ${val}\n╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈❀`
