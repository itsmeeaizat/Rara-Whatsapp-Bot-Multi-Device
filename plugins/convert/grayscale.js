...
const pluginConfig = {
    name: 'grayscale',
    alias: ['greyscale', 'togray', 'abuabu'],
    category: 'convert',
    description: 'Ubah warna gambar menjadi grayscale (hitam putih)',
    usage: '.grayscale',
    example: '.grayscale',
    isOwner: false,
    isPremium: false,
...
async function handler(m, { sock }) {
    ...
    if (!quoted || !isImage) {
        return m.reply(`╭┈❀ *GRAYSCALE IMAGE*\n┃ ◦ Reply ke gambar/sticker yang ingin diubah ke grayscale!\n╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈❀`)
    }
    ...
    try {
        ...
        const caption = `╭┈❀ *GRAYSCALE IMAGE*\n┃ ◦ Berhasil mengubah gambar ke grayscale\n╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈❀`
