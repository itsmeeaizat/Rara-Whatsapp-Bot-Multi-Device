...
const config = {
  info: {
    website: "https://aizat-studio.my.id",
    grupwa: "https://chat.whatsapp.com/example",
  },

  owner: {
    name: "Aizat", // Nama owner
    number: ["6212345678910"], // Format: 628xxx (tanpa + atau 0)
  },
  ...
  bot: {
    name: "Rara Multi Device", // Nama bot
  ...
  assets: {
    ...
    "rara-mp3": "./assets/audio/rara-mp3.mp3",
  ...
  sticker: {
    packname: "Rara Multi Device", // Nama pack sticker
    author: "Aizat", // Author sticker
  },

  saluran: {
    id: "example@newsletter", // ID saluran (contoh: 120363xxx@newsletter)                          // ID saluran (contoh: 120363xxx@newsletter)
    name: "Join saluran resmi Aizat", // Nama saluran
    link: "https://whatsapp.com/channel/example", // Link saluran
  },
